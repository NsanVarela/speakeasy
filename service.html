        ...
        <nav class="navbar bg-dark navbar-expand-lg navbar-light bg-faded nav bg-company-red ">
            ...
            <div id="navbarNavDropdown" class="navbar-collapse collapse">
                ...
                <ul id="menu" class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white current" href="service.html">Service</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="library.html">Library</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="user.html"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
